...
<!----CREATION FORM STARTS---->
                	...
                	<?php echo form_open(base_url() . 'admin/kamar_kosan/update/'.$param2.'/'.$param3.'/' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                 	...
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('Kosan');?></label>
                        <div class="col-sm-12">
                                ...
                                foreach($dormitory as $key => $dormitory):
                                    ...
                                    if($dormitory['id_kosan']== $hostel_room['kamarkosan_id_kosan']){?>
                                        <input type="text" class="form-control" name="dormitory_id" value="<?php echo $dormitory['nama_kosan'];?>" readonly>
                                <?php } endforeach;?>
