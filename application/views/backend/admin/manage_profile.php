<div class="row">
	...
	<div class="col-sm-7">
		<div class="panel panel-info">
			...
			<div class="panel-heading"><i class="fa fa-gear"></i>  <?php echo get_phrase('Edit Profil');?></div>
			<div class="panel-body table-responsive">
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
						<input type="text" class="form-control" name="name" value="<?php echo $row['nama_admin'];?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
						<input type="text" class="form-control" name="no_hp_admin" value="<?php echo $row['no_hp_admin'];?>">
					</div>
				</div>

				<div class="form-group"> 
					 <label class="col-sm-12"><?php echo get_phrase('Foto');?>*</label>        
					 <div class="col-sm-12">
