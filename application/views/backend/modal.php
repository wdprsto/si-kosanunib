        ...
        <div class="modal-dialog">
            <div class="modal-content" style="margin-top:100px;">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" style="text-align:left;"><strong style="color:#FFFFFF">KONFIRMASI&nbsp;</strong></h4>
                </div>
				...
				<div class="row">
				 <div class="col-sm-12">	
				Yakin ingin menghapus informasi ini? Data yang dihapus tidak dapat dikembalikan lagi
				</div>
