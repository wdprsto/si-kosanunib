...
<head>
    ...
    <!-- BAGIAN YANG AKAN DITAMPILKAN  PADA PENCETAKAN TABEL-->
...
<?php } ?>
    ...
    <link href="<?php echo base_url(); ?>optimum/css/colors/<?php echo $this->db->get_where('tb_setting', array('type' => 'skin_colour'))->row()->description; ?>.css" id="theme" rel="stylesheet" >
	<link href="<?php echo base_url(); ?>optimum/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css" rel="stylesheet" >
